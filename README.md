...
|                                                    로그인                                                    |                                                     대시보드                                                     |
|:-----------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
|      <img src="images/login.gif" width="550" height="350" alt="로그인">       |        <img src="images/dashboard.gif" width="550" height="350" alt="대시보드">        |

|                                                     상품 목록                                                     |                                                     상품 등록                                                      |
|:-----------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
|           <img src="images/product-list.gif" width="550" height="350" alt="상품목록">           |           <img src="images/product-register.gif" width="550" height="350" alt="상품등록">           |

|                                                   입고 내역                                                   |                                                     입고 등록                                                     |
|:-----------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
|    <img src="images/inbound-list.gif" width="550" height="350" alt="입고내역">     |       <img src="images/inbound-register.gif" width="550" height="350" alt="입고등록">        |

|                                                출고 내역                                                 |                                                 출고 등록                                                  |
|:-----------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
|   <img src="images/outbound-list.gif" width="550" height="350" alt="출고내역">    |   <img src="images/outbound-register.gif" width="550" height="350" alt="출고등록">    |

|                                                재고 현황                                                 |                                                 통계                                                  |
|:-----------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
|  <img src="images/inventory.gif" width="550" height="350" alt="재고현황">   |   <img src="images/statistics.gif" width="550" height="350" alt="통계">    |

|                                                   사용자 관리 (관리자)                                                    |                                                    사용자 추가 (관리자)                                                     |
|:-----------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
| <img src="images/admin-user-list.gif" width="550" height="350" alt="사용자목록"> | <img src="images/admin-user-add.gif" width="550" height="350" alt="사용자추가"> |

|                                                  공지사항 목록                                                   |                                                   공지사항 등록                                                    |
|:-----------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------:|
|      <img src="images/notice-list.gif" width="550" height="350" alt="공지사항목록">      |       <img src="images/notice-register.gif" width="550" height="350" alt="공지사항등록">       |
